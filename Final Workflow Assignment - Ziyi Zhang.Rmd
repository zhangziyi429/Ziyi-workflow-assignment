...
### Delete useless data 
The first thing I did is very simple, becasue we don't need the last three survey
items anymore (they have very low reliabilities in pilot test), I simply took
...
### Rename colunms 
Then the second thing I did is renaming all IV files becasue they didn't have 
column names before. For this part, I have tried to create a file list with file 
names and then make a for loop. But when I used `r list.files`, r always didn't
...
Then I integrated IV and DV by using `r left_join` function, in order to make it
...
Fortune 500. `r left_join` function is pretty useful because it could automatically
...
definitely increases the fidelity of my data analysis. Becasue at the past, when
...
future. Also, for this current project, R comments and github can help me memeory what
...
re-do the whole work from the beginning becasue I lost where I were. However, when
...
a lot of functions in `r tidyverse` is helpful, that saves me much time.
